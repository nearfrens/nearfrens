...
import { MapButtonWalletNav } from "./mapButtonWalletNav";
...
export const MapButtonWallet = () => {
    ...
    return (
        <>
            ...
            <MapButton
                symbol={ <WalletIcon className="h-6 w-6 text-stone-200 hover:text-white" /> }
                onClick={ switchOpen }
            />
                            ...
                            <div className="pointer-events-none fixed inset-y-0 right-0 flex">
                                ...
                                >
                                    ...
                                    <Dialog.Panel
                                        ...
                                        "
                                    >
                                        <MapButtonWalletNav onClose={ () => switchOpen() }/>
                                    </Dialog.Panel>
