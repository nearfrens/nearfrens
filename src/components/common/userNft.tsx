...
export const UserNftSmall = (props: { nft: IUserNft }) => {
    return (
        <div className={`
            ...
            border
            rounded-lg
            ${ (props.nft && props.nft.active) ? "bg-stone-700" : null } 
            hover:bg-stone-700
        `}
        >
            ...
            <div className="flex flex-row items-center justify-between gap-2">
                <div className="border rounded-full py-1 px-1">
                    {
                        (props.nft && props.nft.network) ?
                        <NetworkChainIcon enumNetwork={ props.nft.network! }/> : null
                    }
                </div>
                <h5 className="w-full text-left">
                    { (props.nft) ? props.nft.title : null }
                </h5>
                <div className="border rounded-lg w-16 px-2 py-0.5 text-xs">
                    { (props.nft) ? props.nft.tokenType : null }
                </div>
            </div>
